...
<!-- css sheet and javascript -->
  ...
  <body>
    ...
    <main>
      ...
      <hr>
      <p>
        Aspects are defined as the specific type of light a person (or other sentient being) can conjure or manipulate. For example, someone with a water aspect is able to transmute pure light into water and control it. This person could also control water that is already present, such as from rivers and oceans. Aspects are obtained from one of the four Beastlords, and each aspect is specific to a certain Beastlord. Generally decided at the moment of birth, the reasons one receives a particular Beastlord's favor are rather arbitrary. The majority of Luxos' population are only able to use one aspect. Certain individuals known as keepers are born with special bonds to the Beastlords, and they are able to use up to three depending on the Beastlord that they are linked to.
      </p>
      <p>
