  ...
  <body>
    <div class="all-content">
      ...
      <main>
        ...
        <hr>
        <p>
          An aspect is defined as a specific type of <a href="light">light</a>, manifesting as a single (magical) element. Each <a href="people">person's</a> heart is tuned to a specific aspect at conception—this correlates to the aspect that they will be able to conjure or manipulate. For example, someone with a water aspect is able to transmute pure light into water and control it at will. This person could also control water that is already present, such as from nearby rivers and oceans. Aspects cannot be acquired by external means or changed. 
        </p>
        <p>
