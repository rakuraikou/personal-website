  ...
  <body>
    ...
    <main>
      <ul class="crumb">
        ...
        <li><a href="beastlords">Beastlords</a></li>
      </ul>
      <h1>
        Beastlords
      </h1>
      ...
      <ul>
        <li>
          <b>Storm</b> : wind, lightning, sun
        </li>
        <li>
          <b>Tide</b> : water, ice, moon
        </li>
        <li>
          <b>Ash</b> : fire, crystal, dust
        </li>
        <li>
          <b>Wild</b> : earth, flora, toxin
        </li>
      </ul>
      <p class="notebox">
      ...
      <hr>
      <p>
        The physical form of the Beastlord itself holds immense power. Tufts of fur, scales, claws, and other trace materials regularly shed from the Beastlords can increase the capacity of a given person's aspect in various ways just by carrying one around as an accessory (aka a talisman).
      </p>
      <p>
