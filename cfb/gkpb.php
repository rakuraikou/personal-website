...
<!-- discord embed -->
    ...
    <meta content="chalk for bones - The Godkiller's Prayer Book" property="og:title">
    <meta content="just some 'poetry' collection" property="og:description">
    <meta content='https://rkrk.dev/res/embed_sprite.png' property='og:image'>
    <meta name="theme-color" content="#810808">
...
<!-- css sheet -->
  ...
  <body>
    ...
    <main>
      <h2>The Godkiller's Prayer Book</h2>
      <h5><i>-- A collection of text addressed to ...no one in particular</i></h5>
      <p class="warning">General warning for religious themes and existentialism/depression. Will add more content warnings underneath titles on a case-by-case basis.</p>
      <ul>
        <li>
          <a href="#patience-in-three">patience in three easy steps</a>
        </li>
        <li>
          <a href="#oops">oops</a>
        </li>
        <li>
          <a href="#ditched-commencement">ditched commencement</a>
        </li>
        <li>
          <a href="#hny">hny</a>
        </li>
        <li>
          <a href="#drifting-me">drifting, me</a>
        </li>
        <li>
          <a href="#drifting-you">drifting, you</a>
        </li>
        <li>
          <a href="#minesweeper">minesweeper</a>
        </li>
        <li>
          <a href="#staring-death-in">staring death in the lips</a>
        </li>
        <li>
          <a href="#genesis">genesis</a>
        </li>
        <li>
          <a href="#reason-four">reason four</a>
        </li>
      </ul>
      <hr>
      <div style="max-height: 500px; overflow: auto">
        ...
        <div class="entry">
          <h4 id="patience-in-three">patience in three easy steps</h4>
          <p>
        ...
        <!-- ditched commencement -->
        <div class="entry">
          <h4 id="ditched-commencement">ditched commencement</h4>
          <p>
        ...
        <div class="entry">
          <h4 id="hny">hny</h4>
          <p>maybe this year will be the year</p>
          <p>...maybe last year</p>
        </div>
        <!-- drifting, me -->
        <div class="entry">
          <h4 id="drifting-me">drifting, me</h4>
          <p style="color:#2e8daa">
        ...
        <!-- drifting, you -->
        <div class="entry">
          <h4 id="drifting-you">drifting, you</h4>
          <p style="color:#2d9b57">
          ...
          <p style="color:#1a7451">
            but with each passing wave, the surface gets just a bit further away. you don't notice it <span style="color:#0b3a46">(nobody really does at first)</span>. but, at some point, you look all around and wonder where the hell all this water came from, as if you weren't the one to stand here in the first place. you <i>know</i> what an ocean is.
          </p>
          <p style="color:#105855">
            you wonder if climate change has anything to do with the rising waters, but the truth is you wouldn't have to wonder that at all <span style="color:#2d9b57">if you just got up and left sooner</span>. it's too late now, though. you can't even see your legs.
          </p>
          <p style="color:#0b3a46">
            you look up at the water's surface, unable to make out the sky from its film. it's like looking into heaven, and even though you can't <i>really</i> see it, you actually feel like you're staring god in the eye as you sink further and further. you wish he'd lend a hand and pull you free. you wish anyone would. but he doesn't. and neither does anyone else. 
          </p>
        </div>
        <!-- minesweeper -->
        <div class="entry">
          <h4 id="minesweeper">minesweeper</h4>
          <p>
            30x16, 99 mines - <i>1m25s</i> - sheer fucking luck
          </p>
          <p>
            there's really no way i could ever beat that record
          </p>
          <p>
            i can <i>rush</i> all i want
          </p>
          <p>
            but i'll hit a mine at some point
          </p>
          <p>
            i am not the best at thinking <i>fast</i>
          </p>
          <p>
            and when i'm asked why i even try
          </p>
          <p>
            <i>without a moment's hesitation</i> i reply:
          </p>
          <p>
            it's fun.
          </p>
        ...
        <div class="entry">
          <h4 id="staring-death-in">staring death in the lips</h4>
          <p class="warning">cw: death, suicide implied</p>
          <p>
            plagued by images and prose of those whose deaths i've seen and read. remnants of their very coldness splattered across <span title="busted wrecks drenched in blood"><u>old cars</u></span> and <span title="unmoving, breathless bodies"><u>sidewalks</u></span>.
          </p>
          <p>
        ...
        <!-- reason four -->
        <div class="entry">
          <h4 id="reason-four">reason four</h4>
          <p>
