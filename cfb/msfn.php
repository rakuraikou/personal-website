...
<!-- discord embed -->
    ...
    <meta content="chalk for bones - Mesofauna" property="og:title">
...
<!-- css sheet -->
  ...
  <body>
    ...
    <main>
      <h2>Mesofauna</h2>
      <h5><i>-- people who i've folded into quarters and put into my back pocket</i></h5>
      <ul>
        <li>
          <a href="#neighborly-stroll">neighborly stroll</a>
        </li>
        <li>
          <a href="#airport-uber">airport uber</a>
        </li>
        <li>
          <a href="#the-dentist">the dentist</a>
        </li>
        <li>
          <a href="#botanical-gardens">botanical gardens</a>
        </li>
        <li>
          <a href="#grocery-store-sushi">grocery store sushi</a>
        </li>
      </ul>
      <hr>
      <div style="max-height: 500px; overflow: auto">
        <!-- neighborly stroll -->
        <div class="entry">
          <h4 id="neighborly-stroll">neighborly stroll</h4>
          <p>
            On November 5th, I was walking to the strip mall by my apartment. I saw a woman with a stroller and assumed maybe there was a baby on board. As I approached closer, though, I found that there were actually <i>two</i> babies. Two cats, to ensure that we are on the same page here.
          </p>
          <p class="blockquote">
        ...
        <!-- airport uber -->
        <div class="entry">
          <h4 id="airport-uber">airport uber</h4>
          <p>
        ...
        <!-- the dentist -->
        <div class="entry">
          <h4 id="the-dentist">the dentist</h4>
          <p>
        ...
        <!-- botanical gardens -->
        <div class="entry">
          <h4 id="botanical-gardens">botanical gardens</h4>
          <p>
        ...
        <!-- grocery store sushi -->
        <div class="entry">
          <h4 id="grocery-store-sushi">grocery story sushi</h4>
          <p>
