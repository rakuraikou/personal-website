...
<!-- discord embed -->
    ...
    <meta content="chalk for bones - Stay Curious" property="og:title">
...
<!-- css sheet -->
  ...
  <body>
    ...
    <main>
      <h2>Stay Curious</h2>
      <h5><i>-- live laugh love lmao</i></h5>
      <ul>
        <li>
        ...
        <li>
          <a href="#lifes-tiniest-pleasures">lifes tiniest pleasures</a>
        </li>
        <li>
          <a href="#bright">bright</a>
        </li>
        <li>
          <a href="#on-brother">on: brother</a>
        </li>
        <li>
          <a href="#eat-slow">eat slow</a>
        </li>
      </ul>
      <hr>
      <div style="max-height: 500px; overflow: auto">
        <!-- folly -->
        <div class="entry">
          <h4 id="folly">folly</h4>
          <p style="color:#9056a1">
            you and i are ridiculous
          </p>
          <p style="color:#c04b86">
        ...
        <div class="entry">
          <h4 id="lifes-tiniest-pleasures">life's tiniest pleasures</h4>
          <p style="color:#740000">
        ...
        <!-- bright -->
        <div class="entry">
          <h4 id="bright">bright</h4>
          <p>
            the first japanese word you taught me was “bright”
          </p>
          <p style="margin-left: 90px; font-size: 1.2em; color:#b96f32">
            明
          </p>
          <p style="margin-left: 10px; color:#c04b86">
          ...
          <p>
            it was from that moment of realization onwards that i found myself understanding that kanji. <span style="color:#c04b86">again.</span> and <span style="color:#b96f32">again.</span> and <span style="color:#4278a3">again.</span>
          </p>
        </div>
        <!-- on: brother -->
        <div class="entry">
          <h4 id="on-brother">on: brother</h4>
          <p>
        ...
        <div class="entry">
          ...
          <p>
            when i was younger, my dad used to tell me to eat fast. any time he caught me ngâm miệng, he'd say the same thing: <u>chew, chew, swallow.</u>
          </p>
          <p>
          ...
          <p>
            today he offered me some of his fish for dinner, since he had grabbed too much from the pot. he told me to take as much as i'd like from his plate. before i even grabbed his plate, he looked at me and said <u>"...and eat slowly."</u>
          </p>
        </div>
      </div>
    </main>
