...
<!-- discord embed -->
    ...
    <meta content="THUNDERSWAG!!! - junkbox" property="og:title">
...
<!-- css sheet and javascript -->
  ...
  <body>
    ...
    <main>
      ...
      <p>
        <a href="chochu/index">FUJIMINE!!</a> : this is the love of my life . 
      </p>
      <p>
      ...
      <p>
        fwends and the like :powercry: Want your button here? don't be afraid to let me know! i love buttons.
      </p>
      <p class="btn-link">
      ...
      <ul>
        <li>
          This page uses the <a href="https://fonts.google.com/specimen/Rubik">Rubik</a> font under the <a href="https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL">Open Font License</a>
        </li>
        <li>
