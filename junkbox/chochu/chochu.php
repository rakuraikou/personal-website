...
<!-- discord embed -->
    ...
    <meta content="THUNDERSWAG!!! - CHOCHU" property="og:title">
  ...
  <body>
    ...
    <main>
      ...
      <div class="wrapper">
        ...
        <h2 style="letter-spacing: 0.5rem; text-align: center; margin-bottom: 0"><span style="color: #ff9ff2!important; font-size: 1.7rem">❤</span>CHOCHU<span style="color: #ff9ff2!important; font-size: 1.7rem">❤</span></h2>
        <p style="margin: 0; font-style: italic; text-align: center; letter-spacing: 0.2rem; font-size: 1.2rem; color: #ff9ff2; font-variant: small-caps">
          fujimine x shitsuren
        </p>
        <hr>
          <div style="display: flow-root">
            <img src="res/cc_zokuzoku.png" style="width: 180px; max-width: 40%; float: right; padding-left: 10px">
            <ul>
              <li>their shipname is CHOCHU (蝶ちゅ) / ButterflyKiss, or FujiRen, if you like mashing names together</li>
              <li>fujimine has many petnames for shitsuren, including:</li>
              <ul>
                <li>shicchan</li>
                <li>my butterfly</li>
                <li>my lovecat</li>
                <li>my sweetest [love/majik/etc.]</li>
              </ul>
              <li>they're not in a committed relationship, but they are definitely some sort of lovers</li>
            </ul>
            <p>
