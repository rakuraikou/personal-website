...
<!-- discord embed -->
    ...
    <meta content="THUNDERSWAG!!! - Art Fight 2024 Journal" property="og:title">
    <meta content="LEN's Art Fight adventure! Warning: This page is pretty media-heavy (lots of animated images)!" property="og:description">
...
<!-- css sheet and javascript-->
  ...
  <body>
    ...
    <main>
      ...
      <p style="font-weight: bold;">Submit only animated attacks, with a minimum of 20.</p>
      <p>
      ...
      <p>
        Table of Contents:
        <ul>
          <li><a href="#one">Attack 1 - chismosa</a></li>
          <li><a href="#two">Attack 2 - eternal winter? no problem</a></li>
          <li><a href="#three">Attack 3 - ITS A RACE TO HELL</a></li>
          <li><a href="#four">Attack 4 - have you even watched osea??</a></li>
          <li><a href="#five">Attack 5 - can't sit still</a></li>
          <li><a href="#six">Attack 6 - now exploring...</a></li>
          <li><a href="#seven">Attack 7 - snapshots</a></li>
          <li><a href="#eight">Attack 8 - then will you bring deliverance to me?</a></li>
          <li><a href="#nine">Attack 9 - surprise!</a></li>
          <li><a href="#ten">Attack 10 - you, me...</a></li>
          <li><a href="#eleven">Attack 11 - timid knight</a></li>
          <li><a href="#twelve">Attack 12 - chipi chipi chapa chapa</a></li>
          <li><a href="#thirteen">Attack 13 - had the STRANGEST dream...</a></li>
          <li><a href="#fourteen">Attack 14 - number one victory royale</a></li>
          <li><a href="#fifteen">Attack 15 - batter up!</a></li>
          <li><a href="#sixteen">Attack 16 - just gettin by</a></li>
          <li><a href="#seventeen">Attack 17 - kinseys enchanted journey</a></li>
          <li><a href="#eighteen">Attack 18 - the huntress</a></li>
          <li><a href="#nineteen">Attack 19 - chimera's boys</a></li>
          <li><a href="#twenty">Attack 20 - ART TENNIS!!!!</a></li>
          <li><a href="#pm">Post-Mortem</a></li>
        </ul>
      </p>
      <hr>
      <!-- attack 1 -->
      <h4 id="one">Attack 1 - chismosa</h4>
      <div class="af-table">
        <img src="/res/af/01_chismosa.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/5911632.chismosa">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~terrortooth">terrortooth</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>58</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>6h10m</span>
          </div>
        </div>
      </div>
      <p>
        This was my first attack of the year, and it's a revenge! Mandrake drew these <a href="https://artfight.net/attack/5824176.its-lunchtime-date-outfits">splendid date outfits</a> for Raiden and Araceli.
      </p>
      <p>
      ...
      <!-- attack 2 -->
      <h4 id="two">Attack 2 - eternal winter? no problem</h4>
      <div class="af-table">
        <img src="/res/af/02_lightmattered.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/6153444.eternal-winter-no-problem">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~LewisSorbet">LewisSorbet</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>231.25</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>4h7m</span>
          </div>
        </div>
      </div>
      <p>
        Once again a revenge, Lewis started the fight with this <a href="https://artfight.net/attack/5827814.bolting-from-where">absolutely breath-taking piece</a> of my main OCs. Of course I had to revenge the best I could.
      </p>
      <p>
        Julián wasn't originally going to be in this attack. That closeup was going to be Vihaan again, with his eye swirling. However, pretty early on, I learned that my friend Ango was also attacking Lewis with his OC ship Lightmatter...so I promptly shifted my idea lol. For the combo.
      </p>
      <p>
      ...
      <!-- attack 3 -->
      <h4 id="three">Attack 3 - ITS A RACE TO HELL</h4>
      <div class="af-table">
        <video controls>
          <source src="/res/af/03_alcmaw.mp4" type="video/mp4">
          Your browser doesn't support video tags, watch from <a href="https://www.youtube.com/watch?v=7ZkFmRnOGWE">YouTube</a> instead!
        </video>
        <div class="af-table-right">
          <a href="https://artfight.net/attack/6352026.its-a-race-to-hell">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~udachox">udachox</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>281.75</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>7h42m</span>
          </div>
        </div>
      </div>
      <p>
        Another revenge! Ox drew this <a href="https://artfight.net/attack/5855696.002-raiden-bite-your-friends">scampy Raiden</a> as a sort of redraw of the one she drew for me in 2022.
      </p>
      <p>
      ...
      <!-- attack 4 -->
      <h4 id="four">Attack 4 - have you even watched osea??</h4>
      <div class="af-table">
        <video controls>
          <source src="/res/af/04_osea.mp4" type="video/mp4">
          Your browser doesn't support video tags, watch from <a href="https://www.youtube.com/watch?v=x-odFvg6mGY">YouTube</a> instead!
        </video>
        <div class="af-table-right">
          <a href="https://artfight.net/attack/6528640.have-you-even-watched-osea">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~squidknees">squidknees</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>180.5</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>7h16m</span>
          </div>
        </div>
      </div>
      <p>
      ...
      <!-- attack 5 -->
      <h4 id="five">Attack 5 - can't sit still</h4>
      <div class="af-table">
        <img src="/res/af/05_besties.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/6745157.cant-sit-still">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~piryion">piryion</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>158.75</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>3h21m</span>
          </div>
        </div>
      </div>
      <p>
      ...
      <ol>
        <li>A member of DSA submits the user information of someone not in DSA who attacked them</li>
        <li>Every few days (I think it was five?), someone random is picked from the pool of submitted users</li>
        <li>Whoever wants to participate in the event draws an attack for the selected user</li>
      </ol>
      <p>
      ...
      <!-- attack 6 -->
      <h4 id="six">Attack 6 - now exploring...</h4>
      <div class="af-table">
        <img src="/res/af/06_offshore.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/6829247.now-exploring">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~angogo">angogo</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>33.5 (friendly fire, 169)</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>7h9m</span>
          </div>
        </div>
      </div>
      <p>
        Back to revenges! Ango drew this <a href="https://artfight.net/attack/5929673.duty-as-the-death-of">amazing and lore-potent</a> Lunchtime that absolutely gutted me on impact. 
      </p>
      <p>
      ...
      <!-- attack 7 -->
      <h4 id="seven">Attack 7 - snapshots</h4>
      <div class="af-table">
        <img src="/res/af/07_idriet.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/6927776.snapshots">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~Hk-Victory">Hk-Victory</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>149.75</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>3h50m</span>
          </div>
        </div>
      </div>
      <p>
        Another revenge, this time for Hk who drew a <a href="https://artfight.net/attack/6251053.purple">lovely and soft Lunchtime</a>. I was a bit intimidated to draw Hk's characters, as most of them have wings or hairstyles that I'm just not used to drawing, but I gave it my all!
      </p>
      <p>
        I had a lot of fun putting together the grid background for this. By this point, I had a solid understanding of Clip Studio's animation folders and how to best organize them (or... how to <i>better</i> organize them, at the very least).
      </p>
      <p>
      ...
      <!-- attack 8 -->
      <h4 id="eight">Attack 8 - then will you bring deliverance to me?</h4>
      <div class="af-table">
        <video controls>
          <source src="/res/af/08_unholy.mp4" type="video/mp4">
          Your browser doesn't support video tags, watch from <a href="https://www.youtube.com/watch?v=3G0b3b4TH2Q">YouTube</a> instead!
        </video>
        <div class="af-table-right">
          <a href="https://artfight.net/attack/7187742.then-will-you-bring-deliverance-to-me">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~despeRados">despeRados</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>131 (friendly fire, 655)</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>6h9m</span>
          </div>
        </div>
      </div>
      <p>
        This is a revenge for the <a href="https://artfight.net/attack/6639590.bolt-from-the-blue">stunning Bolt from the Blue poster</a> that Rads drew. She drew something like this for me last year as well! I'm so honored... It's pretty fun to flip between this and the old one hehe.
      </p>
      <p>
      ...
      <!-- attack 9 -->
      <h4 id="nine">Attack 9 - surprise!</h4>
      <div class="af-table">
        <img src="/res/af/09_surprise.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/7307267.surprise">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~wxlnut">wxlnut</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>165</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>2h50m</span>
          </div>
        </div>
      </div>
      <p>
      ...
      <!-- attack 10 -->
      <h4 id="ten">Attack 10 - you, me...</h4>
      <div class="af-table">
        <video controls>
          <source src="/res/af/10_angosplosion.mp4" type="video/mp4">
          Your browser doesn't support video tags, watch from <a href="https://www.youtube.com/watch?v=f1Skvtj7kNg">YouTube</a> instead!
        </video>
        <div class="af-table-right">
          <a href="https://artfight.net/attack/7923001.you-me">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~angogo">angogo</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>423.5 (friendly fire, 2117.5)</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>31h19m</span>
          </div>
        </div>
      </div>
      <p>
        This is a revenge, technically, for <a href="https://artfight.net/attack/7345671.from-the-blue-to-you">this amazing and lore-potent Bolt from the Blue cookie</a> (lol). However, it's also "Angosplosion," a newly-cemented tradition where I go out of my comfort zone to animate something spectacular for my dear friend Ango.
      </p>
      <p>
      ...
      <!-- attack 11 -->
      <h4 id="eleven">Attack 11 - timid knight</h4>
      <div class="af-table">
        <img src="/res/af/11_timid.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/7947886.timid-knight">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~herbleol">herbleol</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>169.5</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>4h3m</span>
          </div>
        </div>
      </div>
      <p>
      ...
      <p>
        ...Boy, was that a workout, lol. I wanted to focus on the cape movement, so I looked at various references of capes blowing in the wind (especially in anime, shoutout to Piccolo DBZ). I ended up just winging most of it because I couldn't wrap my head around the physics and needed to keep things quick. Because I wanted to make the attack "small," I didn't do lineart, and opted for the clean sketch style that I did in a <a href="#eight">previous attack</a>.
      </p>
      <p>
        I did, however, think it was a good idea to paint...? Which was <i>such</i> a decision. I think the final result is quite lovely, but I'd never do it again. It added a couple extra hours and I don't think I pulled off thaaaat well (at least not well enough to justify the time sink). Also, I feel like the character was somewhat off-model, and I feel bad about it. I'm strongly considering drawing the character again after the fight is over, without the pressure of my animation challenge looming over me lol.
      </p>
      <p>
      ...
      <!-- attack 12 -->
      <h4 id="twelve">Attack 12 - chipi chipi chapa chapa</h4>
      <div class="af-table">
        <video controls>
          <source src="/res/af/12_victor.mp4" type="video/mp4">
          Your browser doesn't support video tags, watch from <a href="https://www.youtube.com/shorts/0B617zoc3mk">YouTube</a> instead!
        </video>
        <div class="af-table-right">
          <a href="https://artfight.net/attack/7988095.chipi-chipi-chapa-chapa">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~epoxyoxen">epoxyoxen</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>12.5 (friendly fire, 62.5)</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>2h45m</span>
          </div>
        </div>
      </div>
      <p>
        Technically a revenge for <a href="https://artfight.net/attack/6957695.stardust-02">this really cute Saffron</a>, also sort of an early birthday gift...! 
      </p>
      <p>
      ...
      <p>
        Record speed on this attack, just barely beating out <a href="#nine">my now-second fastest attack</a>! It was a flat-colored bust of a motion I'd already done before, so I wasn't surprised that it went by fast. I've been really getting the hang of using my Bluetooth keyboard to quickly swap between tools and toggle between pairs of frames to check consistency. Overall, I don't think I faced any huge problems in the making of this attack.
      </p>
      <p>
      ...
      <!-- attack 13 -->
      <h4 id="thirteen">Attack 13 - had the STRANGEST dream...</h4>
      <div class="af-table">
        <img src="/res/af/13_casting.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/8302086.had-the-strangest-dream">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~VoidDemoni">VoidDemoni</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>47.5 (friendly fire, 237.5)</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>2h18m</span>
          </div>
        </div>
      </div>
      <p>
        My first attack after recovering from COVID (yeah, I got COVID. Ripped me out of the game for like a week), and a revenge to a friend who drew <a href="https://artfight.net/attack/7433104.miss-celi-herself">my lovely princess</a>. Includes a couple other buddies as well—OCs from <a href="https://artfight.net/~terrortooth">Mandrake</a> and <a href="https://artfight.net/~venat">Jani</a> and myself—which was fun!
      </p>
      <p>
      ...
      <p>
        Because I was just getting back into the swing of things after COVID, I wanted to do something on the easier side. So, I chose to do a tweened attack (so...no frame-by-frame animation)! Working on this mostly felt like making a regular drawing and then using the transform tool to move pieces of my "regular drawing" around like little dolls in a dollhouse. I've never done this before! It was a fun learning experience.
      </p>
      <p>
      ...
      <!-- attack 14 -->
      <h4 id="fourteen">Attack 14 - number one victory royale</h4>
      <div class="af-table">
        <video controls>
          <source src="/res/af/14_coris.mp4" type="video/mp4">
          Your browser doesn't support video tags, watch from <a href="https://file.garden/ZRerbDGLwX_OLW5G/art%20fight%202024/coris.mov">File Garden</a> instead!
        </video>
        <div class="af-table-right">
          <a href="https://artfight.net/attack/8346897.number-one-victory-royale">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~gross-galaxy">gross-galaxy</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>16 (friendly fire, 80)</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>5h54m</span>
          </div>
        </div>
      </div>
      <p>
      ...
      <p>
        I enjoyed grabbing the explosion green screen for the animation lol. Originally, I wasn't going to have an explosion, but then added it in for the funnies. And then I realized the video with the explosion had, well, explosion audio...so instead of just letting it out as a gif, I included a video version with the explosion SFX. Really funny stuff. The Fortnite music was an extra last-minute addition—I added it much later when I was working on the final big reel.
      </p>
      <!-- attack 15 -->
      <h4 id="fifteen">Attack 15 - batter up!</h4>
      <div class="af-table">
        <img src="/res/af/15_sybat.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/8510806.batter-up">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~cataclysmicshadows">cataclysmicshadows</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>29.5 (friendly fire, 147.5)</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>7h11m</span>
          </div>
        </div>
      </div>
      <p>
        Yet another revenge for this really charming <a href="https://artfight.net/attack/6279912.like-a-princess-in-a-fairytale">lunchtime loop</a>! Shay also acquired the most points through the aforementioned Shark Frenzy event, so this doubled as a "revenge" for that.
      </p>
      <p>
        This was also supposed to be a "quick one," and it likely would have been if not for two factors:
      </p>
      <ol>
        <li>I kept getting distracted. I think at least 2 hours on this were spent idling. Lol.</li>
        <li>I wanted to add more and more things. I wasn't planning on rendering this at all at first, but then I put in the hard shading along the edges. And then I added the gradients. And then I touched up the fire. etc etc.</li>
      </ol>
      <p>
      ...
      <!-- attack 16 -->
      <h4 id="sixteen">Attack 16 - just gettin by</h4>
      <div class="af-table">
        <img src="/res/af/16_jacktan.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/8547567.just-gettin-by">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~rikavolt">rikavolt</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>10.75 (friendly fire, 53.75)</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>2h36m</span>
          </div>
        </div>
      </div>
      <p>
        Nothin' new, just revenging some more! Tan drew <a href="https://artfight.net/attack/7863662.ilia">this absolutely bananas Ilia</a>. Every time I see it, my mind goes blank because...well... I am in love with her...anyway...
      </p>
      <p>
      ...
      <!-- attack 17 -->
      <h4 id="seventeen">Attack 17 - kinseys enchanted journey</h4>
      <div class="af-table">
        <video controls>
          <source src="/res/af/17_kinsey.mp4" type="video/mp4">
          Your browser doesn't support video tags, watch from <a href="https://www.youtube.com/shorts/KJBFZm9U7Uk">YouTube</a> instead!
        </video>
        <div class="af-table-right">
          <a href="https://artfight.net/attack/8561818.kinseys-enchanted-journey">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~terrortooth">terrortooth</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>79.25</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>3h20m</span>
          </div>
        </div>
      </div>
      <p>
        Mandrake has done SO <a href="https://artfight.net/attack/6010685.cole">(1)</a> much <a href="https://artfight.net/attack/7437583.love-is-the-death-of-duty-or-something-idk">(2)</a> art for me, I can't even begin to revenge them all...but I've gotta start <a href="https://artfight.net/attack/8293374.cole-d">somewhere</a>!
      </p>
      <p>
        I've never done a turnaround before, not like this. I didn't really look up a good reference for turnarounds (and I don't know if I'd have any luck finding one for a 6-frame loop... Most people who are <i>normal</i> will make a 4-frame or 8-frame turnaround), but I think I did alright using only my beautiful brain. I struggled a lot with lining things up, and I actually had to scrap my first attempt...The strategy that I found most helpful was sketching a very loose base for the rotation, and cleaning it up / adding Kinsey's design features piece by piece. It wasn't as slow of a process as I thought it would be! In fact, I'm pretty sure it would've taken longer had I not done things this way.
      </p>
      <p>
        Once again, I totally winged the fire (but I have some more experience thanks to <a href="#fifteen">a previous attack</a> lol), and I think it turned out alright! At some point, I'd really like to do some exercises/studies with fire, but I don't really have the time for that during Art Fight. Maybe afterwards...
      </p>
      <p>
        Anyway, I think it's pretty clear that I'm satisfied with how this turned out. The audio came from a game that Mandrake streamed to me and others in DSA. Disney Princess: Enchanted Journey, if you've ever heard of it. The audio clip for casting magic is the same, so when Mandrake spam-casted it, it was...um...an experience. Buuuut, I think it works for this animation!
      </p>
      <!-- attack 18 -->
      <h4 id="eighteen">Attack 18 - the huntress</h4>
      <div class="af-table">
        <img src="/res/af/18_ren.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/8594078.the-huntress">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~thalassophobic">thalassophobic</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>104.75</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>4h34m</span>
          </div>
        </div>
      </div>
      <p>
        Super late revenge for Thal, who drew <a href="https://artfight.net/attack/5980820.ugh-hi-girl">this really wicked Cole</a>!
      </p>
      <p>
      ...
      <p>
        The shifting black bars have made a return! I hadn't played with those since last year when I did <a href="https://file.garden/ZRerbDGLwX_OLW5G/twps/twps_in_the_air.mov">that one TWPS animatic</a>. I like the dynamic composition these borders bring to the animation. I was planning on adding a few other things like hard highlights and some background elements, but ultimately decided against it. Can't take too long on these lol, I have to get to 20 by tomorrow.
      </p>
      <!-- attack 19 -->
      <h4 id="eighteen">Attack 19 - chimera's boys</h4>
      <div class="af-table">
        <img src="/res/af/19_chimeras.gif">
        <div class="af-table-right">
          <a href="https://artfight.net/attack/8609826.chimeras-boys">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~hooxiedev">hooxiedev</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>158.5</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>2h27m</span>
          </div>
        </div>
      </div>
      <p>
        Revenge! This is for Hooxie, who drew a <a href="https://artfight.net/attack/7099909.the-lunchtimes">really lovely and gorgeous lunchtime</a> for me earlier this month.
      </p>
      <p>
      ...
      <div class="af-table">
        ...
        <div class="af-table-right">
          <a href="https://artfight.net/attack/8656422.art-tennis">Attack link</a>
          <div class="af-table-item">
            <span>Recipient:</span><a href="https://artfight.net/~angogo">angogo</a>
          </div>
          <div class="af-table-item">
            <span>Points:</span><span>150.25 (friendly fire, 751.25)</span>
          </div>
          <div class="af-table-item">
            <span>Work time:</span><span>6h10m</span>
          </div>
      ...
      <p>
        This was it. The final attack, and of course it's on my dear friend Ango. And yes, their <a href="https://artfight.net/attack/8571694.thea">previous revenge</a> was my excuse to strike.
      </p>
      <p>
      ...
      <p>
        In this attack, I experimented a lot with <i>shortcuts.</i> How fast could I reasonably pull this bad boy together? Very fast, evidently. This attack took the same amount of time as <a href="#one">my first attack</a>. I used a lot of camera movement for the heavy lifting, similar to what I did for <a href="#eighteen">my 18th attack</a>, and that helped a lot with the vibes.
      </p>
      <p>
      ...
      <iframe style="aspect-ratio: 16 / 9; width: 100%!important" src="https://www.youtube.com/embed/YL8z612DYME"></iframe> 
    </main>
