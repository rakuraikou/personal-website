...
<!-- summary -->
      <div style="background-color:#3A414A; border-radius: 5px; border: 3px #292E35 solid; margin-top:10px;">
        <p style="text-align:center; font-size:0.8em; color:#9CA0A4; margin-bottom:0px">Playing Since 9/9/2022</p>

        <div class="rank">
          <span style="font-size: 1.3em">
            <p style="color:#9CA0A4; font-size: 0.8em; margin-bottom:5px">
            Level
            </p>
...
<!-- x rank stats -->
        <div class="xrank">
          <span>
            ...
            <p style="color:#9CA0A4; font-size: 0.8em; margin-top:0px">
            Fresh Season 2023
            </p>
            <p style="margin-bottom:0px; margin-top:0px">
            1854.7
...
<!-- builds -->
      <div class="grid-box grid-mobile-col" style="gap:10px">
...
<!-- .52 gal -->
        <div class="grid-item" style="background-color:#3A414A; border-radius: 5px; border: 3px #292E35 solid; margin-top:10px">
          ...
          <p style="font-size:0.85em; text-align: justify; margin-top: 0px;">
